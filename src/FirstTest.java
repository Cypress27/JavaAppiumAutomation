...
public class FirstTest {
    ...
    public void testSaveTwoArticlesToMyList()
    {
        ...
        String title_before_deleting_article = waitForElementAndGetAttribute(
        ...
        String title_after_deleting_article = waitForElementAndGetAttribute(
                By.xpath("//*[@resource-id='org.wikipedia:id/view_page_title_text']"),
                "text",
                "Cannot find the title of the article",
                5
    ...
    public void assertElementPresent(By by, String error_message)
    {
        ...
        if (amount_of_elements > 0) {
            ...
            String default_message = "There is no element '" + by.toString() + "' in the article";
            throw new AssertionError(default_message + ": " + error_message);
        }
    }
